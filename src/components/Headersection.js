...
const navigation = ["About", "Vision", "Mission", "Services", "Team", "Partner", "Contact Us"];
const navigation1 = [
                  ...
                  <div className="px-2 py-3 space-y-1 sm:px-3">
                    {navigation.map((item, itemIdx) =>
                      itemIdx === 0 ? (
                        ...
                        <a key={item} href="#" className="text-gray-300 hover:bg-gray-700 hover:text-white block px-3 py-2 rounded-md text-base font-medium">
                          {item}
                        </a>
                      )
                    )}
